...
class HucspiderSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        url + 'luzon/r03/angeles' + ext,
        url + 'visayas/r06/bacolod' + ext,
        url + 'luzon/car/baguio' + ext,
        url + 'mindanao/caraga/butuan' + ext,
        url + 'mindanao/r10/cagayan-de-oro' + ext,
        url + 'visayas/r07/cebu-city' + ext,
        url + 'mindanao/r11/davao-city' + ext,
        url + 'mindanao/r12/general-santos' + ext,
        url + 'mindanao/r10/iligan' + ext,
        url + 'visayas/r06/iloilo-city' + ext,
        url + 'visayas/r07/lapu-lapu' + ext,
        url + 'luzon/r04a/lucena' + ext,
        url + 'visayas/r07/mandaue' + ext,
        url + 'luzon/r03/olongapo' + ext,
        url + 'luzon/mimaropa/puerto-princesa' + ext,
        url + 'visayas/r08/tacloban' + ext,
        url + 'mindanao/r09/zamboanga-city' + ext
    ]
